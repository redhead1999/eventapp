                ...
                Column(
                  children: [
                    SizedBox(
                      ...
                      child: Text(
                        "Заработай ${mainData["currency"]}${refercredit} за каждого приглашенного друга",
                    ...
                    rowText(title: "Поделитесь реферальной ссылкой со своими друзьями"),
                    SizedBox(height: Get.height * 0.01),
                    rowText(
                        title:
                            "Друг ${mainData["currency"]}${refercredit} on their first complete transaction"),
                    SizedBox(height: Get.height * 0.01),
                    rowText(
                        title:
                            "Ты получишь ${mainData["currency"]}${signupcredit} в свою копилку"),
                    SizedBox(height: Get.height * 0.02),
                    InkWell(
                      onTap: () {
                        Clipboard.setData(ClipboardData(text: "#$code"));
                        ApiWrapper.showToastMessage("Код скопирован");
                        //   },
                      },
                      child: Row(
