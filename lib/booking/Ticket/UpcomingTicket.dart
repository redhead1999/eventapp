...
class _UpcomingTicketState extends State<UpcomingTicket> {
            ...
            children: [
              orderdata.isNotEmpty
                ...
                children: [
                  ...
                  Center(
                    child: Text("Похоже, вы еще не забронировали ничего",
  ...
  List cancelList = [
    {"id": 1, "title": "У меня появилось другое мероприятие в это время"},
    {"id": 2, "title": "Болезнь"},
    {"id": 3, "title": "Непредвиденные обстоятельства"},
    {"id": 4, "title": "Нет транспорта"},
    {"id": 5, "title": "Не с кем идти"},
    {"id": 6, "title": "Хочу пойти на другое мероприятие"},
    {"id": 7, "title": "Просто хочу отменить"},
    {"id": 8, "title": "Другое"},
  ];
