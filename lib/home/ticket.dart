                        ...
                        Row(
                          children: [
                            Padding(
                              ...
                              child: Text("Использовать баллы из кошелька",
                                  style: TextStyle(
                                      fontSize: 15.sp,
                                      fontFamily: 'Gilroy Bold',
                                      color: dMode
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          Text(
                            "Да, я зарегистрировался в Навигаторн",
                            style: TextStyle(
                                fontSize: 14.sp,
