...
Color darktextColor = const Color(0xff33578b);
...
Color buttonsColor = const Color(0xff33578b);
Color darkbuttonsColor = const Color(0xff33578b);

Color buttonColor = const Color(0xff33578b);
Color buttonboldColor = const Color(0xff33578b);

Color topColor = const Color(0xff33578b);
